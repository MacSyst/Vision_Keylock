...
RegisterKeyMapping("key", "Toggle Lock/Unlock", "keyboard", Vision.Key)

RegisterCommand("key", function(source, rawCommand)
    ...
    if vehicle ~= 0 then
        ...
        ESX.TriggerServerCallback('Vision:Keys:IsVehicleOwner', function(isOwner)
            if isOwner then
